...
Analysis
There is a postive relationship of temperature and latitude, meaning the closer we get to the equator the higher the temperature
...
Hotels were found nearest the ocean shorelines, save for one in Niger.  This is likely due to the temperature range selected as well as no cloudiness
